...
const cases = [
  ...
  ['trumpet', 'トランペット'],
  ['sam is using the macbook', 'サム・イズ・ユージング・ザ・マックブック'],
  ['smartphone', 'スマートフォン'],
  ['notebook', 'ノートブック'],
  ['velvet lantern', 'ベルベット・ランタン'],
  ['crimson waterfall', 'クリムゾン・ウォーターフォール'],
  ['binary sunflower', 'バイナリー・サンフラウアー'],
  ['midnight compass', 'ミドナイト・コンパス'],
  ['quantum teacup', 'クオンタム・ティーカップ'],
  ['harbor festival', 'ハーバー・フェスティバル'],
  ['silver thunder', 'シルバー・サンダー'],
  ['neon library', 'ネオン・ライブラリー'],
